...
export const consultRowSchema=z.object({id:z.uuid(),patient_id:z.uuid(),doctor_id:z.uuid(),type:z.string(),status:z.string(),requested_at:z.string(),scheduled_for:z.string().nullable(),completed_at:z.string().nullable(),
  doctor_note:z.string().nullable(),patient_name:z.string(),doctor_name:z.string(),is_sample:z.boolean()});
export const consultSchema=z.object({id:z.uuid(),patient_id:z.uuid(),doctor_id:z.uuid(),type:z.string(),status:z.string(),requested_at:z.string(),scheduled_for:z.string().nullable(),completed_at:z.string().nullable(),
...
export const consultViewSchema=z.object({consult:consultSchema,messages:z.array(z.object({id:z.uuid(),sender_id:z.uuid(),body:z.string(),sent_at:z.string(),read_at:z.string().nullable()})),

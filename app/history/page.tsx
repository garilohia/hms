...
export default async function HistoryPage({searchParams}:{searchParams:Promise<{profile?:string}>}) {
  ...
  return <AppFrame profile={view.profile} profiles={profiles}><h1 className="page-title">History</h1><History initial={view} today={today}/><ConsultNotes userId={view.profile.id} initial={notes}/></AppFrame>;
}

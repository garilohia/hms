...
| M5 | Patient UI | Onboarding, Today, History, More all work on a 390-px wide viewport; Chrome PWA installable (the Lighthouse PWA category is deprecated; see D010); no horizontal scroll; golden paths 1–2 pass (see §6 and D009). |
